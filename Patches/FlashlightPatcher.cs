...
namespace LethalBelt.Patches {
    ...
    [HarmonyPatch]
    internal class FlashlightPatcher {

        public static PlayerControllerB localPlayerController { get { return StartOfRound.Instance?.localPlayerController; } }
        public static PlayerControllerB GetPreviousPlayerHeldBy(FlashlightItem flashlightItem) => (PlayerControllerB)Traverse.Create
            (flashlightItem).Field("previousPlayerHeldBy").GetValue();
        ...
        public static FlashlightItem GetMainFlashlight(PlayerControllerB playerController)
        {
            ...
            return pocketedFlashlight && (!reservedFlashlight || (pocketedFlashlight.isBeingUsed && !reservedFlashlight.isBeingUsed))
                ? pocketedFlashlight : reservedFlashlight;
        ...
        public static FlashlightItem GetCurrentlySelectedFlashlight(PlayerControllerB playerController) => playerController.
            ...
            ItemSlots[playerController.currentItemSlot] as FlashlightItem : null;
        public static FlashlightItem GetFirstFlashlightItem(PlayerControllerB playerController) { foreach (var item in playerController
                .ItemSlots) { if (item != null && item is FlashlightItem flashlightItem) return flashlightItem; } return null; }
        ...
        private static void OnPocketFlashlight(FlashlightItem __instance) {
            ...
            OnPacketFlashlightLocal(__instance);
        ...
        private static void OnPacketFlashlightLocal(FlashlightItem flashlightItem) {
